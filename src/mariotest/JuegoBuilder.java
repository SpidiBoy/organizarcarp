...
public class JuegoBuilder {
    ...
    public JuegoBuilder crearJugador() {
        System.out.println("[BUILDER] Paso 3/6: Creando jugador...");
        
        validarPreRequisito(handler, "Handler debe inicializarse antes del jugador");
        
        // Spawn inicial del jugador (configurable desde Configuracion)
        this.jugador = new Player(100, 100, 2, handler);
        handler.setPlayer(jugador);
        
        System.out.println("[BUILDER] ✓ Jugador creado en spawn (100, 100)");
        return this;
    }
